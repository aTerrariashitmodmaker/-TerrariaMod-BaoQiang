...
{
    public class 金蝉弹幕 : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.timeLeft = 180;//弹幕存活时间，帧
            ...
            Projectile.extraUpdates = 7;//额外刷新，1是每帧刷新2次代码
        ...
        {
            target.buffImmune[BuffType<爆胆>()] = false;
            target.AddBuff(BuffType<爆胆>(), 60 * 8);
            target.AddBuff(BuffID.Confused, 60 * 8);
        }
    }
}
