...
{
    public class 赤鼬弹幕 : ModProjectile
    {
        ...
        void drawTrail()
        {
            ...
            for(int i = 0; i < ProjectileID.Sets.TrailCacheLength[Type]; i++)
            {
                if (Projectile.oldPos[i] != Vector2.Zero)
                {
                    ...
                    vertices.Add(new Vertex(pos1, new Vector3(i / 10f, 0, 0), new Color(197, 35, 111)));
                    vertices.Add(new Vertex(pos2, new Vector3(i / 10f, 1, 0), new Color(197, 35, 111)));
                }
            }
